...
export const InstagramLatestPost: React.FC<InstagramLatestPostProps> = ({ profile }) => {
  ...
  if (loading) {
    return (
      <Card className="bg-blue-700 backdrop-blur-sm shadow-xl border border-blue-600 hover:shadow-2xl transition-all duration-300 h-[618px] w-[366px]">
        ...
        <CardContent className="px-4 py-2 h-[578px] overflow-hidden">
  ...
  if (error || !latestPost) {
    return (
      <Card className="bg-blue-700 backdrop-blur-sm shadow-xl border border-blue-600 hover:shadow-2xl transition-all duration-300 h-[618px] w-[366px]">
        ...
        <CardContent className="px-4 py-2 h-[578px] overflow-hidden flex items-center justify-center">
    ...
    <Card className="bg-blue-700 backdrop-blur-sm shadow-xl border border-blue-600 hover:shadow-2xl transition-all duration-300 h-[618px] w-[366px]">
      ...
      <CardContent className="px-4 py-2 h-[578px] overflow-hidden">
        <div className="rounded-lg overflow-hidden h-full flex flex-col">
          ...
          {/* Post Image */}
          <div className="relative mb-2 h-[544px] w-[334px] mx-auto">
